...
mods.Delivery.Store.addTrade("ASSISTANT_MANAGER",<contenttweaker:hopperducts>, warehouse, <modcurrency:banknote:5>*20);
...
mods.Delivery.Store.addTrade("REGIONAL_MANAGER",<contenttweaker:colossal>, warehouse, <contenttweaker:bank_item>.withTag({Total: 22000.0 as float, display: {Lore: ["$22000.0"]}}));
mods.Delivery.Store.addTrade("REGIONAL_MANAGER",<contenttweaker:storagenetwork>, warehouse, <contenttweaker:bank_item>.withTag({Total: 30000.0 as float, display: {Lore: ["$30000.0"]}}));
mods.Delivery.Store.addTrade("REGIONAL_MANAGER",<contenttweaker:ae2>, warehouse, <contenttweaker:bank_item>.withTag({Total: 50000.0 as float, display: {Lore: ["$50000.0"]}}));
mods.Delivery.Store.addTrade("REGIONAL_MANAGER",<contenttweaker:refinedstorage>, warehouse, <contenttweaker:bank_item>.withTag({Total: 50000.0 as float, display: {Lore: ["$50000.0"]}}));
