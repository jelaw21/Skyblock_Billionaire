...
mods.Delivery.Store.addTrade("REGIONAL_MANAGER",<contenttweaker:thermal>, manufactories, <contenttweaker:bank_item>.withTag({Total: 45000.0 as float, display: {Lore: ["$45000.0"]}}));
mods.Delivery.Store.addTrade("REGIONAL_MANAGER",<contenttweaker:eu2>, manufactories, <contenttweaker:bank_item>.withTag({Total: 30000.0 as float, display: {Lore: ["$30000.0"]}}));
mods.Delivery.Store.addTrade("REGIONAL_MANAGER",<contenttweaker:industforegoing>, manufactories, <contenttweaker:bank_item>.withTag({Total: 35000.0 as float, display: {Lore: ["$35000.0"]}}));
