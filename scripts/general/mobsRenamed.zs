...
game.setLocalization("entity.Spider.name", "Health Violation");
game.setLocalization("entity.Ghast.name", "Lonely Unsatisfied Singleton");
game.setLocalization("entity.PigZombie.name", "Angry Soccer Dad");
game.setLocalization("entity.Enderman.name", "Spoiled Millenial");
game.setLocalization("entity.Endermite.name", "Young Spoiled Millenial");
